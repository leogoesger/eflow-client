...
class MetricCard extends React.Component {
  ...
  handleSaveAsImageBtn() {
    let fileName = `${this.props.data.name}_Year_${this.state.currentYear}_Flow_Plot.jpeg`;
      ...
      >
        <Card style={styles.container}>
          ...
          <MetricGaugeDrawer
            ...
            handleHydrographOverlay={(bool) =>
              this.handleHydrographOverlay(bool)
            }
