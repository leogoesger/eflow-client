...
export const classInfo = {
  class1: {abbre: 'SM', fullName: 'Snowmelt', gaugeCount: 24},
  class2: {
    abbre: 'HSR',
  ...
  class4: {abbre: 'WS', fullName: 'Winter Storms', gaugeCount: 34},
  class5: {abbre: 'GW', fullName: 'Groudwater', gaugeCount: 1},
  class6: {
    abbre: 'PGR',
    fullName: 'Perenial Groundwater and Rain',
    gaugeCount: 56,
  },
  class7: {abbre: 'FER', fullName: 'Flashy, ephemeral rain', gaugeCount: 12},
  class8: {
    abbre: 'RSG',
